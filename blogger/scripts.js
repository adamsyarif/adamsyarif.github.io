...
const RUN = {
  ...
  displayMenu: ()=>{
    APP.data('menu', r =>{
      ...
      r.folder = name => '<summary class="w3-ul" onclick="$(this).find(\'i\').toggleClass(\'fa-folder fa-folder-open\')"><label class="w3-bar-item w3-hover-light-gray"><i class="fas fa-folder w3-text-yellow w3-margin-right"></i>'+ name +'</label></summary>';
